<template>
    <footer
        ...
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">©
            {{ dataFooter() }}
            <a href="https://marcionavarro.com.br/" class="hover:underline">marcionavarro™</a>.
            {{ t("diretitosReservados") }}.
        </span>

        <ul class="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
            <NuxtLink v-for="rota in rotasSistemasFooter()" :key="rota.nome" :to="rota.path"
...
const { t } = useI18n();
const rotasSistemasFooter = ref(rotasSistemas)
